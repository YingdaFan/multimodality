...
def log_normal(x, mu, var):
    """Logarithm of normal distribution with mean=mu and variance=y_0_hat_batch, _ = self.cond_pred_model(batch_x, batch_x_mark, dec_inp, batch_y_mark_input)var
...
class NsDiffForecast(ProbForecastExp, NsDiffParameters):
    ...
    def run(self, seed=42) -> Dict[str, float]:
        ...
        while self.current_epoch < self.epochs:
            ...
            self.early_stopper(val_result['crps'], 
