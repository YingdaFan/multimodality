"""
NsDiff CAMELS Experiment for RAW Pipeline (Stage 2 works in original Y space)
...
Usage:
    python NsDiff_CAMELS_Raw.py runs --seeds='[1]'
"""
...
@dataclass
class NsDiffCAMELSRaw(ProbForecastExp, NsDiffRawParameters):
