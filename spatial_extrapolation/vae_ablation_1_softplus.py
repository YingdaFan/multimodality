...
# =============================================================================
# 2. Conditional VAE - Ablation 1 (Softplus only)
# =============================================================================

class ConditionalBasinVAE(nn.Module):
    """
    Ablation 1: Softplus constraint only.
    """
    ...
    def __init__(self,
        ...
        # No final ReLU activation (baseline)
