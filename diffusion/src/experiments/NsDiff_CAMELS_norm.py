"""
NsDiff CAMELS Experiment for NORM Pipeline (Stage 2 works in per-basin normalized space)
...
Usage:
    python NsDiff_CAMELS_norm.py runs --seeds='[1]' --masked_basin_ids 01022500 02069700
"""
...
@dataclass
class NsDiffCAMELSNorm(ProbForecastExp, NsDiffNormParameters):
    """
    NsDiff for CAMELS NORM Pipeline (per-basin normalized space)
