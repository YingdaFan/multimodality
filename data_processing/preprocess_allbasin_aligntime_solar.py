...
def prep_data(
    ...
    Args:
        ...
        add_cumulative: Whether to add rolling-window features (dswrf sum, tmp avg, tcdc avg)
    """
...
if __name__ == "__main__":
    ...
    train_dates = ('1994-01-01', '2004-12-31')  # 11 years training data
    val_dates = ('2005-01-01', '2006-12-31')    # 2 years validation data
    test_dates = ('1994-01-01', '2004-12-31')   # 2 years test data

    # Parse command line arguments for basins to exclude
    # Usage: python preprocess_allbasin_aligntime_solar.py [basin1] [basin2] ...
    ...
    if len(sys.argv) > 1:
        ...
        # Example: exclude_basins_list = ['ACME', 'ADAX', 'ALTU']
    ...
    prep_data(
        csv_file='../../Solar.parquet',  # Path to Solar.parquet
        ...
        add_cumulative=True,     # 7/14/30d rolling features (dswrf sum / tmp avg / tcdc avg)
    )
