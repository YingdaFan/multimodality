...
@dataclass
class iTransformerForecast(ProbForecastExp, iTransformerParameters):
    model_type: str = "iTransformer_forecast"
    ...
    def _process_train_batch(self, batch_x, batch_y, batch_x_date_enc, batch_y_date_enc):
        """
        iTransformer: inverted Transformer that treats channels as tokens.
        Encode-only: input history, output all features, extract Y.
        """
