...
class NsDiff(nn.Module):
    """
    NsDiff for forecasting (no wave fusion).
    Keeps c_out/d_model support for enhanced denoise.py (XConditionNetwork).
    """
