...
class ConditionalBasinVAE(nn.Module):
    ...
    def __init__(self,
        ...
        # Encoder: encode only flow into latent space
        ...
        self.feature_encoder = nn.Sequential(
            ...
            nn.Dropout(dropout),
            nn.Linear(hidden_dim, hidden_dim),
            nn.ReLU(),  # Modification 3: ReLU activation added
            nn.Dropout(dropout)
        )
    ...
    def forward(self, features: torch.Tensor, flow_stats: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        # Modification 2: Clamp for numerical stability
...
def vae_loss(outputs: Dict[str, torch.Tensor],
    ...
    Parameters:
    - beta: weight of the KL term (beta-VAE)
    """
